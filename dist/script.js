...
window.addEventListener('DOMContentLoaded', function () {
  ...
  videoPlayer.init();
  var modulesOld = new _modules_modules__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officerold .officer__card-item');
  modulesOld.init();
  var modulesNew = new _modules_modules__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officernew .officer__card-item');
  modulesNew.init();
});
  ...
  _createClass(Modules, [{
    ...
    value: function hideItems() {
      ...
      this.items.forEach(function (item) {
        if (item !== _this.items[_this.items.length - 1]) {
    ...
    value: function bindBtns() {
      ...
      this.btn.addEventListener('click', function () {
        _this2.childes.forEach(function (child) {
          if (!(child == _this2.firstChild || child == _this2.btn)) {
            _this2.showItems(i);
          }
        });
...
var Slider = function Slider() {
  ...
  this.container = document.querySelector(container); // Получаем страницу

  this.slides = this.container.children; // Получаем всех детей страницы
